<?php
$pageTitle         = 'Perfil Administrativo';
...
<div class="card" id="perfil-admin-contenido">
  ...
  <div class="detalle-grid">
    ...
    <div class="detalle-campo"><div class="detalle-label">Último Acceso</div><div class="detalle-valor"><?= $usuario['ultimo_acceso'] ? htmlspecialchars((new DateTime($usuario['ultimo_acceso']))->format('d M Y, H:i')) : 'Sin registros' ?></div></div>
...
<div class="modal-overlay" id="modal-editar-perfil-admin">
  <div class="modal">
    ...
    <form method="POST" action="index.php?controller=perfilAdmin&action=actualizarPerfil" id="form-perfil-admin" novalidate>
...
<div class="modal-overlay" id="modal-cambiar-clave-admin">
  <div class="modal">
    ...
    <form method="POST" action="index.php?controller=perfilAdmin&action=cambiarClave" id="form-clave-admin" novalidate>
      <div class="modal-body">
